<template>
  <el-dialog
    ...
    <div class="uploadItem" style="margin-top: 15px">
      <DirectoryUpload style="margin-left: 76px; width: 78%;" @onFileSuccess="onFileSuccess" @onFileAdded="onFileAdded"/>
    </div>
...
import DirectoryUpload from "@/components/common/DirectoryUpload";

export default {
  name: "DatasetUploadDialog",
  components: { DatasetUploadList, DirectoryUpload },
  props: {
    showDialog: {
      type: Boolean,
      default: false
